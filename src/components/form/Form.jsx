...
function Form() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setSubmissionError("Failed to connect to server. Try again later.");
    } finally {
            ...
            <div className="p-4 rounded shadow bg-white">
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="mb-3 form-check">
                  <input type="checkbox" className="form-check-input" id="agree" name="agree" checked={formData.agree} onChange={handleChange} required />
